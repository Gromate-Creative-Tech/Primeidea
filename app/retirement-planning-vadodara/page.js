...
const PAGE_PATH = "/retirement-planning-vadodara";
const PAGE_URL = `https://primeidea.in${PAGE_PATH}`;

const faqs = [
  {
    question: "What is retirement planning support at PrimeIdea in Vadodara?",
    answer:
...
export const metadata = {
  title: "Retirement Planning in Vadodara",
  description:
    "PrimeIdea Ventures helps investors in Vadodara and across Gujarat and India with research-led retirement planning through a process guided by Partha Shah, SEBI Registered Research Analyst INH000017815. No guaranteed corpus or returns. Market risks apply.",
  keywords:
    "retirement planning Vadodara, retirement corpus review Gujarat, NPS retirement planning India, Partha Shah SEBI RA INH000017815, PrimeIdea Ventures",
  author: "Partha Shah",
  robots: "index, follow",
  openGraph: {
    type: "website",
    ...
    title: "Retirement Planning in Vadodara | PrimeIdea Ventures",
    description:
      "Research-led retirement planning in Vadodara, guided by Partha Shah, SEBI Registered Research Analyst INH000017815. No guaranteed income or returns.",
  },
  twitter: {
    handle: "@primeidea",
    site: "@primeidea",
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Retirement Planning in Vadodara",
  description:
    "Research-led retirement corpus, allocation, and withdrawal planning support in Vadodara, guided by Partha Shah, SEBI Registered Research Analyst INH000017815.",
  provider: {
...
export default function RetirementPlanningVadodaraPage() {
  return (
    <div className="bg-[#F6FDFF]">
      ...
      <ScopeFaqsSection
        ...
        description="How corpus and withdrawal planning is reviewed in Vadodara, and how to start with a portfolio review."
        faqs={faqs}
      />
