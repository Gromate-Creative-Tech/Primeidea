...
const GetStarted = () => {
    ...
    return (
        <section className="bg-gradient-to-br from-[#232D63] to-[#1a2142] text-white py-12 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="text-[36px] xl:text-5xl font-extrabold text-white mb-6 leading-tight">
                        Start Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Retirement Journey</span>
                    </h2>
                    <p className="text-gray-300 text-xl mb-10 leading-relaxed">
                        Ready to secure your financial future? Let us help you create a personalized retirement plan 
                        that aligns with your goals. Take the first step towards a worry-free retirement today.
                    </p>
                    <button 
                        onClick={toggle}
